...
?>
            <div class="pagetitle">
                <span class="recenter">This Month</span> <button type="button" class="cornerbuttons">Clear</button><a href ="month_edit.php"><button type="button" class="cornerbuttons">Edit</button></a>
            </div>
            <div class = "month">
                <div class = "monthname">
                        <?php  
